...
#define FG99_RESTART_HELP    0x6020  // restart address after help viewer (SADDR)
#define FG99_RESTART_FOLDER  0x6028  // restart address after folder change (SADDR)
...
static uint8_t genFolderEntry(const uint8_t *fn)
{
  ...
  writeByte(FG99_RESTART_FOLDER >> 8);  // start addr of FinalGROM
  writeByte(FG99_RESTART_FOLDER & 0xff);
