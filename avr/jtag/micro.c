...
*               The XSVF data is retrieved by readByteJ() in ports.c
...
int xsvfDoXREPEAT( SXsvfInfo* pXsvfInfo )
{
    readByteJ( &(pXsvfInfo->ucMaxRepeat) );
...
*               See port.c:readByteJ for source of XSVF data.
* Parameters:   none.
